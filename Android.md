...
4. The Init Process:
   ...
   - The init process takes its configuration and settings from a specific file called init.rc.
  	### **The init.rc File:**
	   - The init.rc file is crucial for the init process and is present in the root system of all Android operating systems,
   		regardless of whether they are 64-bit or 32-bit.
...
8. System Server Starts Android system services:
   - Launched by Zygote
